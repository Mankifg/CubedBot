...
class erCog(commands.Cog, name="european records command"):
    def __init__(self, bot: commands.bot):
        self.bot = bot

    @discord.command(
        name="er",
        description="Show current European records.",
    ...
    async def er(self, ctx, event):
        ...
        try:
            ...
            q = discord.Embed(
                title="Could not fetch European records",
                description=(
                    "The European-records data source could not be loaded right now.\n"

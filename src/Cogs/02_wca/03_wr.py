...
class wrCog(commands.Cog, name="world records command"):
    def __init__(self, bot: commands.bot):
        self.bot = bot

    @discord.command(
        name="wr",
        description="Show current world records.",
    ...
    async def wr(self, ctx, event):
        ...
        try:
            ...
            q = discord.Embed(
                title="Could not fetch world records",
                description=(
                    "The world-records data source could not be loaded right now.\n"
